...
<title>Software Store-Confirmation</title>
<meta name="keywords"
...
<script type="text/javascript">
	...
	function submitok() {
		...
		document.getElementById("getExpressCheckout").action = "/ec/do_express_checkout.action?orderID ="
				+ orderid;
		console.log(orderid);
		console.log(document.getElementById("getExpressCheckout").action);
		document.getElementById("getExpressCheckout").submit();
	}
</script>
...
<body>
	<div id="wrap">
		...
		<div id="templatemo_main">
			<form name="getExpressCheckout" id="getExpressCheckout" method="post"
				action="#">
				<div id="request_form">
					<p>&nbsp;</p>
					<div align="center">
						<h2>
							<strong>Order information Confirmation</strong>
						</h2>
					</div>
					<p align="center">
						Order:
					...
					<table width="120" border="0" align="right">
						...
						<tr>
							<td><div align="center">
									<strong><s:property value="model.Total" /></strong>
								</div></td>
						</tr>
					</table>
					<p>&nbsp;</p>
					<p>&nbsp;</p>
					<p align="right">
						<input type="submit" alt="Confirmation" align="right" width="100"
							value="Confirmation of payment" onclick="submitok()">
					</p>
				</div>
				<input type="hidden" name="model.tokens" id="model.tokens"
					value="<s:property   value="model.token" />"> <input
					type="hidden" name="model.orderID" id="orderID"
					value="<s:property   value="model.orderID" />">
			</form>
			<div>
				<p>&nbsp;</p>
				<p>&nbsp;</p>
