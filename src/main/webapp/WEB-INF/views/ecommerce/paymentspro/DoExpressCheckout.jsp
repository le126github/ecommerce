			...
			<div id="request_form">
				<div class="params">
					...
					<s:property value="model.orderID"/>
						<input type="text" name="model.token" value="<s:property value="model.orderID"/>s" />
					</div>
				</div>
				<div class="params">
					<div class="param_name">Payer ID*</div>
					<div class="param_value">
					<s:property value="model.currencyCodeType"/>
						<input type="text" name="model.PayerID" value="<s:property value="model.orderID"/>s" size="50"
							maxlength="260" />
					</div>
				</div>
				<div class="params">
