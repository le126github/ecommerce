com.linkage.service.edialup = new Object();

com.linkage.service.edialup.onChangeGroupID = function onChangeGroupID(obj1,obj2,obj3,obj4) {
	/**
	**		@func		组别onChange事件
	...
	**/
	...
	com.linkage.service.edialup.onChangeCallingType(obj1,obj2,obj3,obj4);
}

com.linkage.service.edialup.onChangeCallingType = function onChangeCallingType(obj1,obj2,obj3,obj4) {
	/**
...
com.linkage.service.edialup.onChangeNewGroupID = function onChangeNewGroupID(obj1,obj2,obj3,obj4) {
	/**
	**		@func		组别onChange事件
	**		@param  Object obj1 组别; Object obj2 组别附加字段fixedrentflag; Object obj3 主叫类型
	**/
	...
	com.linkage.service.edialup.onChangeNewCallingType(obj1,obj2,obj3,obj4);
}

com.linkage.service.edialup.onChangeNewCallingType = function onChangeNewCallingType(obj1,obj2,obj3,obj4) {
	/**
	**		@func		主叫类型onChange事件 新开时
	**		@param  Object obj1 组别; Object obj2 组别附加字段fixedrentflag; Object obj3 主叫类型
	**/
...
com.linkage.service.edialup.onChangeModCallingType = function onChangeModCallingType(obj1,obj2,obj3,obj4) {
	/**
...
com.linkage.service.edialup.onChangePayType = function onChangePayType(obj1,obj2,obj3) {
	/**
	**		@func		付费方式onChange事件
	**		@param  Object obj1 组别; Object obj2 组别附加字段fixedrentflag; Object obj3 主叫类型
	**/
...
/*
com.linkage.service.edialup.sel_servicefee = function sel_servicefee(){
...
com.linkage.service.edialup.isValidUserPassword = function isValidUserPassword(obj,obj1) {
	/**
...
com.linkage.service.edialup.isValidGroupID = function isValidGroupID(obj,obj1) {
	/**
...
com.linkage.service.edialup.isValidCallingNO = function isValidCallingNO(obj1,obj2,obj3,obj4,obj5,obj6) {
	/**
...
com.linkage.service.edialup.isValidModGroupID = function isValidModGroupID(obj,obj1,obj7,obj2,obj3,obj4,obj5,obj6) {
	if(!com.linkage.service.edialup.isValidGroupID(obj,obj1))
	    return false;
	if(!com.linkage.service.edialup.isValidCallingNO(obj7,obj2,obj3,obj4,obj5,obj6))
	    return false;

	return true;
}

com.linkage.service.edialup.isValidLimitFee = function isValidLimitFee(obj) {
	/**
	**		@func		窄带用户组别校验 包括是否有可用组别 是否选择组别 是否有组别附加信息
...
com.linkage.service.edialup.isValidLimitUsers = function isValidLimitUsers(obj) {
	/**
	**		@func		窄带用户组别校验 包括是否有可用组别 是否选择组别 是否有组别附加信息
	**		@param  Object obj	当月费用限额
	**/
...
com.linkage.service.edialup.isValidDates = function isValidDates(obj1,obj2,obj3,obj4,obj5) {
	/**
...
com.linkage.service.edialup.isValidPayType = function isValidPayType(obj1,obj2,obj3,obj4) {
	/**
	**		@func		时间校验
...
com.linkage.service.edialup.processStatus = function processStatus(obj,str){
    if(obj == null) obj = document.forms[0].status;
    obj.value = str;
}

com.linkage.service.edialup.isValidExpireDate = function isValidExpireDate(obj1,obj2,obj3){
...
com.linkage.service.edialup.sel_status = function sel_status(obj1,obj2,obj3){
    if(obj1 == null) obj1 = document.forms[0].oldstatus;
    if(obj2 == null) obj2 = document.forms[0].currentdate;
    if(obj3 == null) obj3 = document.forms[0].expiredate;
    var status = obj1.value;
...
com.linkage.service.edialup.sel_cancel_status = function sel_cancel_status(obj1){
    if(obj1 == null) obj1 = document.forms[0].oldstatus;
    var status = obj1.value;
    if(status == "0"){
...
com.linkage.service.edialup.sel_groupid = function sel_groupid(obj){
    ...
    if(result == null){
        ...
        com.linkage.service.edialup.onChangeCallingType();
        com.linkage.service.edialup.onChangeNewCallingType();
    }else if(result == "1"){
        document.all("div_groupid").style.display = "";
        document.all("div_newgroupid").style.display = "";
        com.linkage.service.edialup.onChangeCallingType();
...
com.linkage.service.edialup.sel_roam = function sel_roam() {
	/**
	**		@func		隐藏/显示国际漫游模块
	**/
...
com.linkage.service.edialup.roamInitValid = function roamInitValid() {
	/**
...
com.linkage.service.edialup.roamInputValid = function roamInputValid() {
	/**
...
com.linkage.service.edialup.trim = function trim(str){
	/**
	**		@func		提出字符串中的空格
	**/
    	var i = 0;
...
com.linkage.service.edialup.init = function init(){
	document.forms[0].elements
		['model.roamInfo.comp_id.username'].focus();
}

com.linkage.service.edialup.onChangeAreano = function onChangeAreano(str) {
	com.linkage.service.edialup.prepareInfo(str);
}

com.linkage.service.edialup.prepareInfo = function prepareInfo(str) {
	document.forms[0].action = "/vpdn/mclient/dialupvpdn/"+str+"_prepare.action";
	document.forms[0].submit();
}

com.linkage.service.edialup.isValidEDialupQuery = function isValidEDialupQuery(obj1,obj5,obj6,obj7) {
